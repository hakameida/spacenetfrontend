// app/playstations/page.tsx
"use client";

import React, { useState, useEffect } from "react";
import { AllPlayStationPage } from "@/feature/all-playstation-page";
...
import { Play, Tag, Sparkles, ChevronLeft, ChevronRight, Shield, Phone, MessageCircle, ZoomIn, Gamepad2 } from "lucide-react";
import Image from "next/image";
import Head from "next/head";

const promoMessages = [
  "يوجد لدينا توصيل لكافة المحافظات",
  "افضل الاسعار للبلايستيشن",
...
export default function PlayStationPage() {
  ...
  return (
    <>
      <Head>
        <title>اسعار بلايستيشن في سوريا بحصة</title>
        <meta name="description" content="بلايستيشن 4 وبلايستيشن 5 بارخص الاسعار وافضل الانواع في سبيس ستور" />
        <meta name="keywords" content="بيع بلايستيشن, بلايستيشن بحصة, بلايستيشن بارخص الاسعار بحصه, PS4, PS5" />
      </Head>
      ...
      <div className="w-full mx-auto mb-4 mt-1 pt-14 md:pt-16">        
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 md:py-0">
            ...
            <div className="text-center mb-6 md:mb-8 animate-fadeInDown">
              ...
              <p className="text-lg sm:text-xl md:text-3xl text-blue-200 font-light drop-shadow-md">
                أفضل عروض البلايستيشن في سوريا
              </p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl p-4 md:p-8">
                <div className="min-h-[100px] md:min-h-[120px] flex items-center justify-center">
                  <div className="text-center animate-fadeIn">
                    <div className="inline-block p-2 md:p-3 rounded-full bg-gradient-to-r from-blue-500/30 to-indigo-500/30 mb-3 md:mb-4">
        ...
        <div className="sm:container w-[90%] mx-auto">
          ...
          <MultipleItemsOffer productModule="PLAYSTATION" />
          ...
          <div className="flex items-center gap-3 mb-4 mt-12">
            <div className="p-2 rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm">
              <Gamepad2 className="w-8 h-8 md:w-10 md:h-10" style={{ color: "rgba(34,82,154,1)" }} />
            </div>
            <h2
