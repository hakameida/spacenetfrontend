...
export default function ComputerPartsPage() {
  ...
  return (
    <>
      <Head>
        <title>قطع كمبيوتر - اسعار كمبيوتر في سوريا بحصة</title>
        <meta name="description" content="جميع قطع الكمبيوتر: معالجات، كروت شاشة، رامات، مذربورد، مزودات طاقة، تبريد - بارخص الاسعار في سبيس ستور" />
        <meta name="keywords" content="قطع كمبيوتر, معالجات, كروت شاشة, رامات, مذربورد, مزودات طاقة, تبريد, كمبيوتر بحصة" />
      </Head>
          ...
          <div className="flex items-center gap-3 mb-4 mt-12">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm md:text-base">
                معالجات، كروت شاشة، رامات، مذربورد، مزودات طاقة، تبريد
              </p>
            </div>
          </div>
