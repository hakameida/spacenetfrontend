...
import { AllAccessoryPage } from "@/feature/all-accessory-page";
...
const promoMessages = [
  ...
  "افضل الاكسسوارات وبافضل الاسعار",
  "كفالة ذهبية على جميع المنتجات",
...
export default function AccessoriesPage() {
  ...
  return (
    <>
      <Head>
        <title>اسعار اكسسوارات في سوريا بحصة</title>
        <meta name="description" content="اكسسوارات جيمينغ ومكتبي بارخص الاسعار وافضل الانواع في سبيس ستور" />
        <meta name="keywords" content="بيع اكسسوارات جيمينغ, اكسسوارات بحصة, اكسسوارات بارخص الاسعار بحصه, ماوس, كيبورد, سماعات" />
      </Head>
      ...
      <div className="w-full mx-auto mb-4 mt-1 pt-14 md:pt-16">        
        ...
        <div className="relative w-full h-auto md:h-[600px] lg:h-[700px] overflow-hidden pb-8">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 md:py-0">
            ...
            <div className="text-center mb-6 md:mb-8 animate-fadeInDown">
              ...
              <p className="text-lg sm:text-xl md:text-3xl text-purple-200 font-light drop-shadow-md">
                أفضل الاكسسوارات في سوريا
              </p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl p-4 md:p-8">
                <div className="min-h-[100px] md:min-h-[120px] flex items-center justify-center">
                  <div className="text-center animate-fadeIn">
                    <div className="inline-block p-2 md:p-3 rounded-full bg-gradient-to-r from-purple-500/30 to-pink-500/30 mb-3 md:mb-4">
                    ...
                    <div className="mt-3 md:mt-4 flex justify-center gap-2">
                      <div className="w-8 md:w-12 h-0.5 bg-purple-400 rounded-full" />
        ...
        <div className="sm:container w-[90%] mx-auto">
          ...
          <MultipleItemsOffer productModule="ACCESSORY" />
          ...
          <div className="my-6 md:my-8">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-700" />
          ...
          <div className="flex items-center gap-3 mb-4 mt-12">
            <div className="p-2 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm">
              <Headphones className="w-8 h-8 md:w-10 md:h-10" style={{ color: "rgba(34,82,154,1)" }} />
            </div>
            <h2
          ...
          <AllAccessoryPage title="" />
          
          {/* Videos Section */}
          <div className="flex items-center gap-3 mb-4 mt-12">
            <div className="p-2 rounded-xl bg-gradient-to-br from-purple-500/20 to-red-500/20 backdrop-blur-sm">
