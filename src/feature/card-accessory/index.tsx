...
const CardAccessory = ({
  ...
  return (
    <div className="card-accessory h-full flex flex-col rounded-xl overflow-hidden border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 bg-white">
