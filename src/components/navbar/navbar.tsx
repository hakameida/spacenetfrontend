...
const Navbar = () => {
  ...
  const navLinks = [{ name: "اكسسوارات", href: `/accessories` }, { name: "موبايلات", href: `/mobiles` }, { name: "لابتوبات", href: `/` },{naame : "كومبيوتر", href:'/computer'}];
    ...
    <nav className="sticky top-0 left-0 w-full h-[70px] bg-white overflow-hidden shadow-md z-50">
      <div className="container mx-auto flex justify-between items-center h-[70px]">
        <ul className="flex items-center justify-center">
          ...
          <a
            href={'/computer'}
            className={`${pathname == "/computer" ? "active-link" : "link"}`}
          >
